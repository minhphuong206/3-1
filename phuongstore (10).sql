...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `role` tinyint(1) DEFAULT '0' COMMENT '1: Super Admin, 0: Staff',
...
INSERT INTO `admin` (`ma_admin`, `ten_dang_nhap`, `mat_khau`, `ho_ten`, `anh_admin`, `role`, `permissions`) VALUES
(1, 'admin', '123456', 'Quản Trị Viên Chính', 'logo.png', 1, 'all'),
(4, 'admin1', '123456', 'minh phương', 'staff_1767530690.jpg', 0, 'orders');
...
INSERT INTO `giohang` (`ma_gio_hang`, `ma_khach_hang`, `ngay_cap_nhat`) VALUES
(1, 8, '2026-01-04 14:16:49');
...
(8, 'pn2062004@gmail.com', '$2y$10$9I85sqBFGLAU6V.l/2PkeO6EC.hS3WkmYsbukENAFrLm7h7.NITau', 'minh phương', '0369451564', '123/9, Phường 04, Quận 8, Thành phố Hồ Chí Minh', 0, NULL, NULL, NULL);
